...
const WhatsAppButton = ({ phoneNumber, message }) => {
  ...
  return (
    <a
      ...
      className=" bg-[#006B8D] hover:bg-[#3288a3] transition-colors duration-300 py-2 text-white px-2 font-bold py-2 px-4 rounded-full inline-flex items-center"
    >
      <svg xmlns="http://www.w3.org/2000/svg" className='h-6 w-6' x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
